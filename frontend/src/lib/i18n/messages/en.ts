...
export const en = {
  ...
  authPasswordPreview: {
    ...
    signUp: {
      ...
      codeStepSubtitle: "Enter the code we sent to {email}.",
      verify: "Verify and continue",
      verifying: "Verifying…",
      passwordStepTitle: "Set your password",
      passwordStepSubtitle: "Your email is verified — choose a password to finish creating your account.",
      haveAccount: "Already have an account?",
      signInLink: "Sign in",
    },
    signIn: {
