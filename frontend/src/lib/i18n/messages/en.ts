...
export const en = {
  ...
  landing: {
    nav: {
      ...
      audienceLink: "Who it's for",
      solutionsLink: "Solutions",
      howItWorksLink: "How it works",
      valueLink: "Why Aladdin",
    },
    hero: {
      eyebrow: "Egypt's finishing sector",
      titleBrand: "Aladdin",
      titleLine2: "connects every side of finishing",
      subtitle: "On one platform",
      primaryCta: "Get started",
      productAlt: "A real Aladdin workspace",
      secondaryProductAlt: "A closer view of a real Aladdin workspace",
      visualPlaceholderNote: "Needed: real showroom/finishing-material photography (marble, wood, architectural lighting) for this zone.",
      proof: {
        network: { headline: "Verified", caption: "A real professional network" },
        direct: { headline: "Direct", caption: "No middleman" },
        journey: { headline: "End to end", caption: "From discovery to execution" },
      },
    },
    audienceRail: {
      heading: "Who Aladdin is for",
      ...
      items: {
        ...
        engineers: "Engineers",
        tradespeople: "Tradespeople & Technicians",
        salesTeam: "Sales Team",
        personal: "Personal Account",
      },
    },
    platform: {
      eyebrow: "Real software, not a mockup",
      title: "Every finishing product, in one place",
      body: "Discover products, compare offers, and track your projects — in one place.",
      cta: "Explore products",
      visualPlaceholderNote: "Needed: a dark architectural scene with real finishing materials behind the product UI.",
    },
    value: {
      items: {
        time: { title: "Save time and effort", body: "Everything your project needs, in one platform." },
        direct: { title: "Direct, easier contact", body: "Reach suppliers and showrooms directly, no middleman." },
        trust: { title: "A trusted space for real professionals", body: "Verified organizations and professionals, with real data." },
      },
    },
    finalCta: {
      title: "Start your journey with Aladdin today",
      subtitle: "Join the platform and reach bigger opportunities for your business.",
      primaryCta: "Create account",
      secondaryCta: "Sign in",
      visualPlaceholderNote: "Needed: real finishing/furnishing photography.",
    },
    footer: {
  ...
  legal: {
    pendingTitle: "Content coming before public launch",
    pendingBody:
      "The real, reviewed text for this page hasn't been published yet — this is an honest placeholder, not a substitute. It will be in place before public registration opens.",
    terms: { title: "Terms of Service" },
    privacy: { title: "Privacy Policy" },
    backToHome: "Back to Aladdin",
  },
  auth: {
    ...
    error: {
      ...
      verifyFailed: "That code is incorrect. Check it and try again.",
  ...
  registration: {
    ...
    error: {
      ...
      usernameShape: "Username may contain only letters, numbers, \".\" and \"_\", must start with a letter, and can't start, end, or double up on separators.",
      usernameUnavailable: "That username isn't available. Try another.",
    },
  },
  phoneField: {
  ...
  profileIdentity: {
    ...
    displayName: {
      label: "Display name",
      hint: "What businesses and other people see on your profile.",
      confirm: "Save",
      saving: "Saving…",
      saved: "Saved",
      confirmedHint: "Confirmed",
      unconfirmedHint: "Not confirmed yet — the name shown was set automatically.",
      error: "Enter a display name (1-80 characters).",
    },
    phone: {
      label: "Phone",
      hint: "Used to reach you. Not shown to other people.",
      save: "Save phone",
      saving: "Saving…",
      saved: "Phone saved",
      unavailable: "That phone number is unavailable. Please use a different one.",
    },
    avatar: {
      label: "Profile photo",
      change: "Change photo",
      ...
      saved: "Photo updated",
      remove: "Remove",
      errorType: "Please choose a JPEG, PNG, or WebP image.",
      errorSize: "That image is too large. Please choose a smaller file.",
      errorUpload: "We could not upload your photo. Please try again.",
    },
  },
  completeProfile: {
    title: "Complete your profile",
    subtitle: "A few more details help others find and trust you.",
    ...
    missing: {
      ...
      locality: "Add your location",
      display_name: "Confirm your display name",
      headline: "Add a headline",
      years_experience: "Add your years of experience",
      activities: "Choose your specializations",
      bio: "Write a short bio",
      organization_activities: "Choose your business activities",
      organization_setup: "Set up your business",
    },
  },
  profileActivities: {
    title: "What you offer",
    body: "Choose every activity that applies. You can change this at any time.",
    save: "Save",
    saving: "Saving…",
    saved: "Saved",
    empty: "Choose at least one to help others find you.",
    saveFailed: "We could not save this. Please try again.",
    unavailable: "One of these options is no longer available. Please review your choice.",
    notAllowed: "You do not have permission to change this.",
    labels: {
      decor_showroom: "Decor showroom",
      paint_showroom: "Paint showroom",
      decor_and_paint_showroom: "Decor & paint showroom",
      building_and_finishing_supplies_retailer: "Building & finishing supplies retailer",
      distributor: "Distributor",
      wholesaler: "Wholesaler",
      paint_manufacturer: "Paint manufacturer",
      decor_manufacturer: "Decor manufacturer",
      decor_supplies_importer: "Decor supplies",
      paint_importer: "Paints",
      finishing: "Finishing",
  ...
  onboarding: {
    ...
    accountType: {
      ...
      selected: "Selected",
      comingSoon: "Coming soon",
      comingSoonHint: "Not open for new registrations yet.",
      types: {
        end_consumer: "Personal Account",
        ...
        installer_technician: "Tradespeople & Technicians",
    ...
    error: {
      ...
      comingSoon: "This option isn't open for new registrations yet.",
    ...
    professional: {
      ...
      specializations: {
        ...
        // The 14 active trades (staging-prep Increment 3,
        // 20260924090003_audience_activities.sql). Wording pending product-owner copy review.
        wallpaper_installation: "Wallpaper installation",
        gypsum_board_installation: "Gypsum board installation",
        wood_alternative_installation: "Wood-alternative installation",
        marble_alternative_installation: "Marble-alternative installation",
        vinyl_flooring_installation: "Vinyl flooring installation",
        hdf_flooring_installation: "HDF flooring installation",
        painting: "Painter / decorator",
        spray_paint_and_foundation: "Spray painting & surface prep",
        decorative_paints: "Decorative finishes",
        astarji: "Wood finishing & polishing (Astarji)",
  ...
  activity: {
    title: "Activity log",
    subtitle: "A clear record of what this organization has done on Aladdin.",
    feedTitle: "Recent activity",
      ...
      empty: {
        ...
        body: "Business actions from this organization will appear here when they happen.",
      },
      filteredEmpty: {
        title: "No activity matches these filters",
        body: "Try another activity type or date range, or return to all activity.",
      },
    error: {
      title: "Activity could not be loaded",
      body: "Try opening the activity log again.",
    },
    noAccess: {
      title: "You cannot view this activity log",
      body: "Ask an organization owner to grant you Activity log access.",
    },
    events: {
      rfq: {
        created: "Request for quotation created.",
        submitted: "Request for quotation submitted with {item_count} line items.",
        updated: "Request for quotation updated.",
        cancelled: "Request for quotation cancelled.",
        closed: "Request for quotation closed.",
      },
      quotation: {
        created: "Quotation created.",
        submitted: "Quotation submitted for {total}.",
        updated: "Quotation updated.",
        accepted: "Quotation accepted for {total}.",
        rejected: "Quotation rejected.",
      },
      order: {
        created: "Order created for {total}.",
        started: "Order work started.",
        completed: "Order completed.",
        cancelled: "Order cancelled.",
      },
      project: {
        created: "Project created.",
        activated: "Project moved into execution.",
        completed: "Project completed.",
      },
      lead: {
        created: "Lead created.",
        details_changed: "Lead details updated.",
      },
      customer: {
      ...
      followup: {
        created: "Follow-up created for {due_at}.",
        completed: "Follow-up completed.",
        reopened: "Follow-up reopened.",
        reassigned: "Follow-up reassigned.",
      },
      affiliation: {
        requested: "Organization membership requested.",
        approved: "Organization membership approved.",
        rejected: "Organization membership request rejected.",
        cancelled: "Organization membership request cancelled.",
      },
      product: {
  ...
  authPasswordPreview: {
    ...
    codeLabel: "One-time code",
    codeDigitLabel: "Digit {position} of {total}",
    captchaLabel: "Human verification challenge",
    resend: "Resend code",
    resendIn: "Resend in {seconds}s",
    changeEmail: "Use a different email",
    requirements: {
      hint: "At least {min} characters ({count} so far). Longer passphrases are stronger — spaces are allowed.",
      tooLong: "Passwords can be at most {max} bytes — a few characters shorter if you use non-Latin script or emoji.",
    },
    strength: {
      weak: "Weak",
      acceptable: "Acceptable",
      strong: "Strong",
      meterLabel: "Password strength: {level}",
    },
    guidance: {
      minLength: "At least {min} characters",
      notCommon: "Not a common or easily guessed password",
      notAccountRelated: "Avoid personal or account information and obvious patterns",
      longer: "Longer passwords or passphrases are stronger — encouraged, not required",
    },
    signUp: {
      title: "Create your Aladdin account",
      subtitle: "Choose an email and password, then verify your email with a one-time code.",
      submit: "Create account",
      submitting: "Creating…",
      codeStepTitle: "Verify your email",
      codeStepSubtitle: "If this email can continue registration, we've sent the next step to {email}.",
      noCodeHint: "No code arriving? You may already have an account.",
      verify: "Verify and continue",
      verifying: "Verifying…",
      haveAccount: "Already have an account?",
      signInLink: "Sign in",
    ...
    forgotPassword: {
      ...
      subtitle: "Enter the email address on your account and we'll send you a code.",
      submit: "Send code",
      submitting: "Sending…",
      backToSignIn: "Back to sign in",
    },
    recoveryVerify: {
      ...
      destinationLabel: "Code sent to {email}",
      verify: "Verify",
      verifying: "Verifying…",
    ...
    migration: {
      ...
      subtitle: "Your account currently signs in without a password. Verify it's you, then choose one.",
      alreadySet: "Your account already has a password — sign in with Email + Password from here on.",
      codeStepSubtitle: "We sent a verification code to {email}.",
      sendCode: "Send verification code",
      sending: "Sending…",
      verify: "Set password",
      verifying: "Setting…",
      done: "Password set — you can now sign in with Email + Password too.",
    },
    changePassword: {
    ...
    info: {
      codeSent: "We sent a code to {email}. It may take a moment to arrive.",
    ...
    error: {
      ...
      accountTypeRequired: "Choose an account type.",
      passwordTooShort: "Password is too short.",
      passwordTooLong: "Password is too long — 72 bytes maximum.",
      passwordCommon: "That password is too common or easy to guess. Choose something less predictable.",
      passwordSequential: "Avoid repeated or sequential characters, like \"aaaa\" or \"1234\".",
      passwordAccountRelated: "Don't use your email or account details in your password.",
      passwordMismatch: "Passwords don't match.",
      passwordRejected: "That password wasn't accepted. Try a different one.",
      recoveryStateMissing: "This recovery session has expired or is no longer valid. Start over.",
      currentPasswordRequired: "Enter your current password.",
      currentPasswordWrong: "That current password isn't correct.",
      ...
      otpExpired: "That code has expired. Request a new one.",
      rateLimited: "Too many attempts. Wait a moment and try again.",
      sessionExpired: "Your session expired. Start again from Create account.",
      captchaRequired: "Complete the verification challenge before continuing.",
      captchaRejected: "That verification challenge didn't pass. Try again.",
      captchaUnavailable: "The verification challenge couldn't load. Refresh and try again.",
    },
  },
};
