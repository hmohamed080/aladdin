...
-- A-owner is the canonical "Personal + Business" identity: an Engineer as a person,
-- who also OWNS the seeded supplier organization. Owning it does not make him a
-- "supplier"; his membership does that, and switching workspace never changes his
-- persona.
update public.users set primary_account_type = 'engineer',          status = 'active' where id = '11111111-1111-4111-8111-111111111111';
