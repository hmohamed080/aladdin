...
`wontfix` already exists on `hmohamed080/aladdin` (GitHub's default, "This will not be worked on") and should be reused, not duplicated. The other four do not exist yet — create them on first use:
