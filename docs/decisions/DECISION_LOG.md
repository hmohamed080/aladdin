...
| [0006](ADR-0006-repository-governance.md) | Repository Governance | Accepted | 2026-08-01 | GitHub flow on protected `main`; branch/commit conventions; `--no-ff` PR merges (no squash/rewrite); SemVer; release/tag workflow; code/doc ownership. | **Active** — `CODEOWNERS` + CI branch-protection are follow-ups. |
