...
| **Testing** | 96% | Stable (strategy + Phase 1/2 suites) | Engineering | 2026-08-03 | **337 pgTAP** assertions across 16 files (254 identity/tenancy + 83 sales) plus two real-session race tests, gated by `supabase-rls` over two clean cycles; frontend **12 tests** pass; backend 10 tests pass on CI. Further suites land with features. |
